...
* Supports keyboard shortcuts: Enter = Yes, Right Arrow = No, Backspace = No, Left Arrow = Back (Undo), Escape = Quit.
* Back button (or Left Arrow) removes the last copied label file (if present) and shows the previous image for relabeling.
